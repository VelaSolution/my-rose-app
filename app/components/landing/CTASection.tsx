    ...
    <section className="cta-bg">
      <div className="section-inner">
        <FadeIn>
          ...
          <Link href="/simulator" className="btn-white" onClick={() => { try { (window as any).gtag?.("event", "cta_click", { event_category: "landing", event_label: "bottom_cta" }); } catch {} }}>시뮬레이터 시작하기 →</Link>
        </FadeIn>
      </div>
    </section>
  );
